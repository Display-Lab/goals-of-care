...
Please review these charts to encourage reflection on your current practice and how \Sexpr{name} might increase the number of goals of care conversations (GOCC) completed LST order templates. \bigskip
...
Thank you for your efforts to conduct GoCC and complete LST templates with Veterans and their families in \Sexpr{name} to improve care and the quality of life for our Veterans.
