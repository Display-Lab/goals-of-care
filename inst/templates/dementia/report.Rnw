...
The following pages present data about the number of goals of care conversations (GoCCs) that were documented using the Life-Sustaining Treatment template for Veterats at the \Sexpr{name}. \bigskip
