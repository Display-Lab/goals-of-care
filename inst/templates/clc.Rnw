...
\begin{itemize}
	...
	\item Veterans are defined as either long stay or short stay residents, based on their treating specialty; those admitted for hospice are counted as long stay residents.
