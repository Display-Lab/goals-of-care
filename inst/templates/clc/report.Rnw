...
<<lt_rate_plot, include=TRUE, message=FALSE, echo=FALSE, warning=FALSE, fig.1p="fig:", fig.keep='all', fig.width = 7, fig.height = 7, fig.align='center', fig.show='hold'>>=
  ...
  title_txt <- paste("How many total newly admitted Veterans have a documented goals of care conversation?",
...
<<lt_cats_plot, include=TRUE, message=FALSE, echo=FALSE, warning=FALSE, fig.1p="fig:", fig.keep='all', fig.width = 7, fig.height = 7, fig.align='center', fig.show='hold'>>=
  ...
  title_txt <- "For patients/residents with a documented GoCC, when was the conversation documented?"
...
<<cats_table, include=TRUE, message=FALSE, echo=FALSE>>=
  table_data <- gocc::category_plot_table_data(plot_data, ctgy_labels)
  knitr::kable(table_data, format="latex", booktabs=T, caption=title_txt)
@
\end{document}
