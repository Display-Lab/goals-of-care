...
\memoto{ \Sexpr{site$name} CLC Providers and Staff }
...
On the reverse side of this page are feedback reports that present data about the completeness and timeliness with which clinicians document goals of care conversations for Veterans admitted to CLC at \Sexpr{site$name}.\bigskip
...
Please review the charts on the reverse side of this page to encourage reflection on your current practice and how \Sexpr{site$name} might increase the number of goals of care conversations and improve documentation of goals of care conversations.\bigskip
...
Thank you for your efforts to increase the frequency of goals of care conversations with Veterans and their families in \Sexpr{site$name} and in ensuring that these important discussions are documented to improve care and the quality of life for our Veterans.
...
\begin{itemize}
  ...
  \item The segments of each column compare the number without documentation to the number who had documentation from the LST template at any time between the first use of the LST template by \Sexpr{site$name}, and up to 30 days following each Veteran's admission.
\end{itemize}
