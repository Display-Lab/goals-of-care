...
Thank you for your efforts to increase the frequency of GoCCs with Veterans and their families in \Sexpr{config$id_names[[selected_id]]} and in ensuring that these important discussions are documented to improve care and the quality of life for our Veterans.
